...
const PROJECTS = [
  {
    ...
    solution: 'Architected a React 19 SPA with Vite 7 and TanStack Router, leveraging Zustand and 50+ TanStack Query hooks to reduce API overhead by 60%. Engineered complex MFA/OTP flows using TanStack Form + Zod for real-time validation.',
    impact: 'Sub-second load times via code splitting, 100% test coverage on critical components with Vitest',
    tech: ['React 19', 'TypeScript', 'Vite 7', 'TanStack Suite', 'Zustand', 'Tailwind CSS', 'Vitest', 'Zod'],
    live: '#',
  ...
  },
  {
    ...
    impact: 'Smooth playback with zero audio gaps, automated content management pipeline',
